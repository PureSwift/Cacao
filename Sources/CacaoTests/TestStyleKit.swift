...
public class TestStyleKit : NSObject {
    ...
    public class func drawText(frame: CGRect = CGRect(x: 0, y: 0, width: 240, height: 120)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        let text2FontAttributes: [String: Any] = [NSFontAttributeName: UIFont(name: "TimesNewRomanPSMT", size: UIFont.labelFontSize())!, NSForegroundColorAttributeName: UIColor.whiteColor(), NSParagraphStyleAttributeName: text2Style]
        ...
        let text3FontAttributes: [String: Any] = [NSFontAttributeName: UIFont(name: "TimesNewRomanPSMT", size: UIFont.labelFontSize())!, NSForegroundColorAttributeName: UIColor.whiteColor(), NSParagraphStyleAttributeName: text3Style]
        ...
        let text4FontAttributes: [String: Any] = [NSFontAttributeName: UIFont(name: "TimesNewRomanPSMT", size: UIFont.labelFontSize())!, NSForegroundColorAttributeName: UIColor.whiteColor(), NSParagraphStyleAttributeName: text4Style]
        ...
        let text5FontAttributes: [String: Any] = [NSFontAttributeName: UIFont(name: "MicrosoftSansSerif", size: 17)!, NSForegroundColorAttributeName: UIColor.blackColor(), NSParagraphStyleAttributeName: text5Style]
