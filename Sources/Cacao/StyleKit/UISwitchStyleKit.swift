...
class UISwitchStyleKit {
    ...
    class func drawSwitchView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 51, height: 31), resizing: ResizingBehavior = .aspectFit, thumbColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), fillColor: UIColor = UIColor(red: 0.687, green: 0.677, blue: 0.675, alpha: 1.000), switchOn: CGFloat = 0, tapped: CGFloat = 0) {
    ...
    class func drawSwitchBackgroundView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 51, height: 31), resizing: ResizingBehavior = .aspectFit, fillColor: UIColor = UIColor(red: 0.687, green: 0.677, blue: 0.675, alpha: 1.000), switchOn: CGFloat = 0, tapped: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Variable Declarations
        let showFilled: CGFloat = switchOn > 0 ? switchOn : tapped
